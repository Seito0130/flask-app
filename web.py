...
def poikatu():
    ...
    poi_list = [
        ...
        {"name": "QuickPoint", "img": "poi2.png", "desc": "PayPay連携が神！", "stars": "★★★★☆", "site_url": "#"},
...
def items():
    ...
    item_list = [
        ...
        {"name": "shiroのwhite lily", "img": "item1.png", "desc": "コスパ最強の香水！", "stars": "★★★★★", "https://shiro-shiro.jp/item/12722.html?category_from=250": "#"},



        {"name": "Applewatch", "img": "item2.png", "desc": "モチベ上がる！ スマホをいちいち操作しなくてもこれで簡潔！", "stars": "★★★★★", "https://www.amazon.co.jp/dp/B0FQGP2P41/ref=fs_a_w_2?th=1": "#"}
